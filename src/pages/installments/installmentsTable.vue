  ...
  <v-container>
    ...
    <div id="dataTable" style="position: relative !important">
      <v-data-table-server item-value="id" v-model:items-per-page="itemsPerPage" v-model:options="options"
        v-model:expanded="expanded" :headers="headers" :items="users" :items-length="total" :loading="loading" hover
        show-current-page :row-props="getRowProps" v-model="selectedUsers" show-select item-selectable
