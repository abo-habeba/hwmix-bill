import{_ as N,r as d,P as S,c as v,d as a,j as o,aF as T,al as I,o as s,a4 as m,a5 as c,U as _,a as x,a9 as f,b as p,k as h,q as y,F as R,A as B,f as $}from"./index-DDCnkNdi.js";import P from"./ThermalInvoicePrint-IBX1k20_.js";import{P as j}from"./ProductSticker-CjMu-J6p.js";const A={class:"print-page"},F="اسم الشركة",L={__name:"[id]",setup(M){const k=$(),n=d(null),u=d(!1),i=d(null),b=d([]);async function g(){const l=sessionStorage.getItem("print_invoice");if(l)try{n.value=JSON.parse(l),sessionStorage.removeItem("print_invoice");return}catch{}const t=k.params.id;if(!t)return;const e=await I("invoices",t);n.value=(e==null?void 0:e.data)||null}S(g);function w(){if(!i.value)return;const t=`
