import{_ as N,r as d,Q as S,c as v,d as a,k as o,aH as T,ar as B,o as s,a4 as m,a5 as c,W as _,a as x,a9 as f,b as p,l as h,s as y,F as I,B as R,g as $}from"./index-mQB-Vo7t.js";import H from"./ThermalInvoicePrint-B4Gu9QYn.js";import{P as L}from"./ProductSticker-DHWbqLD5.js";const M={class:"print-page"},P="اسم الشركة",j={__name:"[id]",setup(z){const k=$(),n=d(null),u=d(!1),i=d(null),g=d([]);async function b(){const l=sessionStorage.getItem("print_invoice");if(l)try{n.value=JSON.parse(l),sessionStorage.removeItem("print_invoice");return}catch{}const t=k.params.id;if(!t)return;const e=await B("invoices",t);n.value=(e==null?void 0:e.data)||null}S(b);function w(){if(!i.value)return;const t=`
