import{_ as N,r as d,P as S,c as v,d as a,j as o,aG as T,ak as I,o as s,a4 as m,a5 as c,U as _,a as k,a9 as f,b as p,k as h,q as x,F as R,A as B,f as $}from"./index-BKsMk_Nc.js";import P from"./ThermalInvoicePrint-fa4tpKIU.js";import{P as j}from"./ProductSticker-da7YMZ5L.js";const A={class:"print-page"},L="اسم الشركة",M={__name:"[id]",setup(q){const y=$(),n=d(null),u=d(!1),i=d(null),b=d([]);async function g(){const l=sessionStorage.getItem("print_invoice");if(l)try{n.value=JSON.parse(l),sessionStorage.removeItem("print_invoice");return}catch{}const t=y.params.id;if(!t)return;const e=await I("invoices",t);n.value=(e==null?void 0:e.data)||null}S(g);function w(){if(!i.value)return;const t=`
