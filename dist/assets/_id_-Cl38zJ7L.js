import{_ as I,r as d,Q as N,c as v,d as a,k as o,aI as S,ar as T,o as s,a5 as m,a6 as c,W as _,a as x,aa as f,b as p,l as h,s as y,F as B,B as R,g as $}from"./index-ncGZ4GRr.js";import L from"./ThermalInvoicePrint-CcwUQYCJ.js";import{P as M}from"./ProductSticker-BUSYpgfB.js";const P={class:"print-page"},j="اسم الشركة",z={__name:"[id]",setup(A){const k=$(),n=d(null),u=d(!1),i=d(null),g=d([]);async function b(){const l=sessionStorage.getItem("print_invoice");if(l)try{n.value=JSON.parse(l),sessionStorage.removeItem("print_invoice");return}catch{}const t=k.params.id;if(!t)return;const e=await T("invoices",t);n.value=(e==null?void 0:e.data)||null}N(b);function w(){if(!i.value)return;const t=`
