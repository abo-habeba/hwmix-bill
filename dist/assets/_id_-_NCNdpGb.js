import{_ as I,r as d,P as N,c as v,d as a,j as o,aI as S,aq as T,o as s,a4 as m,a5 as c,U as _,a as x,a9 as f,b as p,k as h,q as y,F as R,A as B,f as $}from"./index-D4SLvo8z.js";import P from"./ThermalInvoicePrint-tJA3AJH_.js";import{P as j}from"./ProductSticker-BRfV96YV.js";const q={class:"print-page"},A="اسم الشركة",L={__name:"[id]",setup(M){const k=$(),n=d(null),u=d(!1),i=d(null),b=d([]);async function g(){const l=sessionStorage.getItem("print_invoice");if(l)try{n.value=JSON.parse(l),sessionStorage.removeItem("print_invoice");return}catch{}const t=k.params.id;if(!t)return;const e=await T("invoices",t);n.value=(e==null?void 0:e.data)||null}N(g);function w(){if(!i.value)return;const t=`
